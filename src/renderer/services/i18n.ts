...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkExportMarkdown: '导出会话',
    coworkExportMarkdownSuccess: '导出成功',
    coworkExportMarkdownFailed: '导出失败',
    coworkExportMarkdownEmpty: '当前会话无内容可导出',
    deleteSession: '删除任务',
  ...
  en: {
    ...
    coworkExportMarkdownSuccess: 'Export successful',
    coworkExportMarkdownFailed: 'Export failed',
    coworkExportMarkdownEmpty: 'No content to export in current session',
